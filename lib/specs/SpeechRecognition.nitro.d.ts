...
export interface SpeechRecognition extends HybridObject<{
    ios: "swift";
    android: "kotlin";
}> {
    ...
    getSupportedLocales(options: GetSupportedLocalesOptions): Promise<SupportedLocalesResult>;
    ...
    androidTriggerOfflineModelDownload(options: TriggerOfflineModelDownloadOptions): Promise<OfflineModelDownloadResult>;
    setCategoryIOS(options: SetCategoryOptions): void;
    getAudioSessionCategoryAndOptionsIOS(): AudioSessionInfo;
    setAudioSessionActiveIOS(value: boolean, notifyOthersOnDeactivation: boolean): void;
    addResultListener(callback: (event: SpeechRecognitionResultEvent) => void): void;
    addErrorListener(callback: (event: SpeechRecognitionErrorEvent) => void): void;
    ...
    addLanguageDetectionListener(callback: (event: LanguageDetectionEvent) => void): void;
    addVolumeChangeListener(callback: (event: VolumeChangeEvent) => void): void;
    removeListeners(): void;
}
//# sourceMappingURL=SpeechRecognition.nitro.d.ts.map